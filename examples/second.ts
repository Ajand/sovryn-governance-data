...
const contractAddress =
  "0x1401b5b40759893f5e5d5826da709e4fe35c438e".toLowerCase();

const main = async () => {
  const contract = new ethers.Contract(contractAddress, porSetAbi, provider);

  console.log(await contract.admin());
  console.log(await contract.affiliateFeePercent());
  console.log(await contract.affiliateTradingTokenFeePercent());
  console.log(await contract.borrowingFeePercent());
  console.log(await contract.feeRebatePercent());
  console.log(await contract.feesController());
  console.log(await contract.getProtocolAddress());
  console.log(await contract.getFeeRebatePercent());
  console.log(await contract.getLockedSOVAddress());
  console.log(await contract.getSovTokenAddress());
  console.log(await contract.isLoanPool());
};
